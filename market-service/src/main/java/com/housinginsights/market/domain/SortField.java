...
public enum SortField {
    ...
    SQUARE_FOOTAGE(PropertyFieldNames.SQUARE_FOOTAGE, Comparator.comparingDouble(PropertyRecord::squareFootage)),
    ...
    SCHOOL_RATING(PropertyFieldNames.SCHOOL_RATING, Comparator.comparingDouble(PropertyRecord::schoolRating)),
